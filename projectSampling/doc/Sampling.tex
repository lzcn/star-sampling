...
\begin{figure}[H]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=3.3in,viewport = 0 10 650 200]{./img/fig_ml_2k_recall}\\
...
\begin{figure}[H]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=3.3in,viewport = 0 10 650 200]{./img/fig_ml_10m_recall}\\
...
\begin{figure}[H]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=3.3in,viewport = 0 10 650 200]{./img/fig_lastfm_recall}\\
...
\begin{figure}[H]
  \centering
  % Requires \usepackage{graphicx}
  \includegraphics[width=3.3in,viewport = 0 10 650 200]{./img/fig_delicious_recall}\\
